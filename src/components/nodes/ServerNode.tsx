...
const ServerNode: React.FC<NodeProps<NodeData>> = ({ data }) => {
  return (
    <div className="min-w-[150px] bg-white border-2 border-server rounded shadow-md relative">
      <Handle
        type="target"
        position={Position.Top}
        className="!bg-server !w-3 !h-3"
        isConnectable={true}
      />
      <Handle
        type="source"
      ...
      <div className="p-2">
        <div className="flex items-center justify-center mb-2">
          <Server size={32} className="text-server" />
        </div>
